...
@Service
@AllArgsConstructor
public class FindAllParticipanteDetailByEdital {

    private final ProcessoSeletivoRepository repository;
    public List<FindAllParticipanteDetailByEditalResponse> execute(Integer idProcessoSeletivo) {
        Set<Inscricao> inscricoes = this.repository.findAllParticipantesByEdital(idProcessoSeletivo);
        return inscricoes.stream()
                .map(FindAllParticipanteDetailByEditalResponse::of)
                .toList();
    }
}
